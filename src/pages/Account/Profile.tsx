...
import { getUserProfile, updateUserProfile as updateProfileAPI, uploadProfilePicture, clearProfileCache } from '../../services/streamApi';
...
export default function Profile() {
  ...
  const handlePictureUpload = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      // Clear profile cache so fresh data is fetched elsewhere
      if (user?.username) {
